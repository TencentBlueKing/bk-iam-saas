...
<script>
    ...
    const routerMap = new Map([
        ...
        // 我的管理空间
        [['myManageSpace', 'myManageSpaceCreate', 'gradingAdminDetail', 'gradingAdminEdit', 'gradingAdminCreate', 'myManageSpaceSubDetail', 'secondaryManageSpaceCreate', 'secondaryManageSpaceEdit'], 'myManageSpaceNav'],
        // 分级管理员
