        ...
        data () {
            return {
                ...
                typeMap: {
                    ...
                    'role.create': this.$t(`m.audit['分级管理员创建']`),
                    'role.member.create': this.$t(`m.audit['分级管理员成员增加']`),
                    'role.member.delete': this.$t(`m.audit['分级管理员成员删除']`),
                    'role.member.update': this.$t(`m.audit['分级管理员成员修改']`),
                    'role.member.policy.create': this.$t(`m.audit['成员创建默认权限']`),
                    'role.member.policy.delete': this.$t(`m.audit['成员删除默认权限']`),
                    'role.update': this.$t(`m.audit['分级管理员更新']`),
                    'role.group.renew': this.$t(`m.audit['分级管理员用户组成员续期']`),
                    'role.commonaction.create': this.$t(`m.audit['常用操作新建']`),
                    'role.commonaction.delete': this.$t(`m.audit['常用操作删除']`),
