...
<script>
    ...
    import RenderPermSideslider from '../components/render-template-perm-sideslider';
    ...
    export default {
        ...
        async created () {
            // 动态组件暂时不能使用 fetchPageData。这里 fetchPermTemplates 请求需要用到 user.username
            if (!this.user || !Object.keys(this.user).length) {
                await this.fetchUser();
            }
            await this.fetchPermTemplates();
        },
        methods: {
            /**
             * 获取 user 信息
