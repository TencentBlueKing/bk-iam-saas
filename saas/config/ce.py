...
CSRF_COOKIE_DOMAIN = SESSION_COOKIE_DOMAIN  # nosec B324
_APP_URL_MD5_16BIT = hashlib.md5(APP_URL.encode("utf-8")).hexdigest()[8:-8]  # nosec B324
CSRF_COOKIE_NAME = f"bkiam_csrftoken_{_APP_URL_MD5_16BIT}"  # nosec B324
