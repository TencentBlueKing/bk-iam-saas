...
class TestBaseComponentClient(TestCase):
    ...
    def test_api_get(self):
        client = self.ComponentClient(TS['valid_app']['bk_app_code'],
        ...
        self.assertTrue(result['data']['bk_username'],
                        TS['bk_user']['bk_username'])
    ...
    def test_set_bk_api_ver(self):
        ...
        result = client.bk_login.get_user(
            {'username': TS['bk_user']['bk_username']})
        self.assertTrue(result['result'], json.dumps(result))
        self.assertTrue(result['data']['username'],
                        TS['bk_user']['bk_username'])
