...
class CollectionsCC(object):
    ...
    def __init__(self, client):
        ...
        self.translate_host_module = ComponentAPI(
            client=self.client,
            method='POST',
            path='/api/c/compapi{bk_api_ver}/cc/translate_host_module/',
            description=u'业务内主机转移模块')
        self.translate_host_to_faultmodule = ComponentAPI(
            client=self.client,
            method='POST',
            path='/api/c/compapi{bk_api_ver}/cc/translate_host_to_faultmodule/',
            description=u'上交主机到业务的故障机模块')
        self.translate_host_to_idlemodule = ComponentAPI(
            client=self.client,
            method='POST',
            path='/api/c/compapi{bk_api_ver}/cc/translate_host_to_idlemodule/',
            description=u'上交主机到业务的空闲机模块')
        self.translate_host_to_resourcemodule = ComponentAPI(
            client=self.client,
            method='POST',
            path=
            '/api/c/compapi{bk_api_ver}/cc/translate_host_to_resourcemodule/',
            description=u'上交主机至资源池')
        self.translate_resourcehost_to_idlemodule = ComponentAPI(
            client=self.client,
            method='POST',
            path=
            '/api/c/compapi{bk_api_ver}/cc/translate_resourcehost_to_idlemodule/',
            description=u'资源池主机分配至业务的空闲机模块')
        self.translate_sethost_to_idle_module = ComponentAPI(
            client=self.client,
            method='POST',
            path=
            '/api/c/compapi{bk_api_ver}/cc/translate_sethost_to_idle_module/',
        ...
        self.get_proc_config_instance_status = ComponentAPI(
            ...
            method='GET',
            path=
            '/api/c/compapi{bk_api_ver}/cc/get_proc_config_instance_status/',
