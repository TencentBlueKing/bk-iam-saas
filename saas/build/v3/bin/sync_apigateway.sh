...
python manage.py sync_apigw_config -f resources/apigw_settings/definition.yaml
if_error_then_exit $? "sync_apigw_config fail"
log_info "done sync_apigw_config"

log_info "do sync_apigw_stage..."
python manage.py sync_apigw_stage -f resources/apigw_settings/definition.yaml
if_error_then_exit $? "sync_apigw_stage fail"
log_info "done sync_apigw_stage"

log_info "do sync_apigw_resources..."
python manage.py sync_apigw_resources -f resources/apigw_settings/bk_apigw_resources_bk-iam.yaml
if_error_then_exit $? "sync_apigw_resources fail"
log_info "done sync_apigw_resources"

log_info "do sync_resource_docs_by_archive..."
python manage.py sync_resource_docs_by_archive -f resources/apigw_settings/definition.yaml
...
python manage.py create_version_and_release_apigw -f resources/apigw_settings/definition.yaml
